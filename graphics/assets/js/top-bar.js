...
function show() {
	...
	TweenMax.to('.container', 0.5, {scaleY: 1, delay: 1, ease: Power4.easeOut, onStart: () => {
		...
		TweenMax.to('.container span', 0.5, {y: 0, delay: 0.25, ease: Elastic.easeOut.config(0.3, 0.4)});
		TweenMax.to('.container span', 0.5, {y: 144, delay: 5.25, ease: Elastic.easeIn.config(0.3, 0.4), onStart: () => {
			setTimeout(() => {
